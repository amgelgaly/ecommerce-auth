...
const orders = {
  "123456": {
    ...
    total: 2850,
    items: [
      { id: "1", name: "هاتف ذكي جديد", quantity: 1, price: 2500, image: "/placeholder.svg?height=80&width=80" },
      { id: "3", name: "سماعات لاسلكية", quantity: 1, price: 350, image: "/placeholder.svg?height=80&width=80" },
    ],
    paymentMethod: "cod",
    shippingAddress: {
  ...
  "123457": {
    ...
    total: 5000,
    items: [
      { id: "2", name: "لابتوب احترافي", quantity: 1, price: 5000, image: "/placeholder.svg?height=80&width=80" },
    ],
  ...
  "123458": {
    ...
    items: [
      { id: "1", name: "هاتف ذكي جديد", quantity: 1, price: 2500, image: "/placeholder.svg?height=80&width=80" },
      { id: "4", name: "ساعة ذكية", quantity: 1, price: 1000, image: "/placeholder.svg?height=80&width=80" },
    ],
    ...
    return (
      <div className="container py-10 text-center">
        ...
        <Button asChild className="bg-blue-600 hover:bg-blue-700">
          <Link href="/seller/orders">العودة للطلبات</Link>
        </Button>
      </div>
    )
  }
